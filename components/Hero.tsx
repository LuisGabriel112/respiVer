...
import type { Contacto, HeroConfig } from '@/lib/site-config'
...
export default function Hero({ contacto, heroConfig }: HeroProps) {
  const BADGES = [
    {
      icon: (
      ...
      label: contacto.telefono_display,
      href: `tel:${contacto.telefono_href}`,
    },
    {
      icon: (
      ...
      label: contacto.whatsapp_display,
